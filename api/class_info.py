...
@class_router.get("/one/{class_id}", response_model=dict)
...
@class_router.get("/count/month", response_model=dict)
...
@class_router.get("/class_by_lecturer_id/{lecturer_id}", response_model=dict)
