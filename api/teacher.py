...
def update_teacher(teacher_id: int, data: TeacherUpdate, db: Session = Depends(get_db), _: AuthUser = Depends(require_permission("teacher", "update"))) -> Dict[str, Any]:
    """更新指定老师的信息"""
...
def delete_teacher(teacher_id: int, db: Session = Depends(get_db), _: AuthUser = Depends(require_permission("teacher", "delete"))) -> Dict[str, Any]:
    """逻辑删除指定老师信息"""
